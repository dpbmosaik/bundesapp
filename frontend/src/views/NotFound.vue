      ...
      <main class="sm:flex">
        ...
        <div class="sm:ml-6">
          <div class="sm:border-l sm:border-gray-200 sm:pl-6">
            <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Seite nicht gefunden</h1>
            <p class="mt-1 text-base text-gray-500">Bitte überprüfe die die URL in der Adresszeile und versuche es erneut.</p>
          </div>
