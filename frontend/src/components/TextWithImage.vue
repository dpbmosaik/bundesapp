...
<template>
  <div class="bg-white overflow-hidden bg-gray-50">
    <div class="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div class="hidden lg:block bg-gray-50 absolute top-0 bottom-0 left-3/4 w-screen" />
      <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
        <div>
          <h2 class="text-base text-dpbm-blue font-semibold tracking-wide uppercase">Über uns</h2>
          <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Deutscher Pfadfinderbund Mosaik</h3>
        </div>
      </div>
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        ...
        <div class="mt-8 lg:mt-0">
          ...
          <div class="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
            ...
            <div class="mt-10">
                <a target=_blank rel=noopener href="https://dpbm.de/" class="text-base font-medium text-indigo"> Lern mehr darüber wer wir sind und was wir machen <span aria-hidden="true">&rarr;</span> </a>
            </div>
         </div>
        </div>
      </div>
