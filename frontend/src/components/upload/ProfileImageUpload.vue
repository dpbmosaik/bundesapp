<template>
                    ...
                    focus:ring-offset-2 focus:ring-indigo-500"
						...
						<div class="mx-auto">
							<vue-cropper
									...
									:min-crop-box-width="finalCropSize"
									:min-crop-box-height="finalCropSize"
									:min-canvas-width=finalCropSize
									:min-canvas-height="finalCropSize"
									:min-container-width="finalCropSize"
									:min-container-height="finalCropSize"
									drag-mode='move'
									:aspect-ratio="1/1"/>

							<img v-else class="mx-auto" src="@/assets/images/profile_default.jpg">
						</div>
                  ...
                  rounded-l outline-none focus:outline-none mb-1 ease-linear transition-all duration-150"
                   ...
                   rounded-r outline-none focus:outline-none mb-1 ease-linear transition-all duration-150"
						...
						<div class="flex justify-end mb-4">
							<button
									type="button" :disabled="!imageSelected" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4
	...
	<confirm-profile-image-upload ref="confirmUploadModal" @on-confirmed="onConfirmed"/>
</template>
