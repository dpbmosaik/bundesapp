      ...
      <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
        <div class="lg:col-span-1">
          <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Ein besserer Weg deine Arbeit zu erledigen.
          </h2>
        </div>
        <dl class="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
          <div v-for="feature in features" :key="feature.name">
            <dt>
              <div class="flex items-center justify-center h-12 w-12 rounded-md bg-dpbm-blue text-white">
...
<script>
import { UserGroupIcon, CollectionIcon, ChatIcon, InformationCircleIcon, CalendarIcon, DocumentAddIcon, CubeIcon, PlusCircleIcon } from '@heroicons/vue/outline'
