  ...
  <div class="bg-gray-50">
      ...
      <div class="relative pt-6 pb-16 sm:pb-24">
        ...
        <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div class="text-center">
            ...
            >
              Die Bundesapp ist ein Open-Source Projekt des Deutschen
              Pfadfinderbund Mosaik und zielt darauf ab die ehrenamtliche Arbeit
              in Kinder- und Jugendverbänden zu vereinfachen.
            </p>
            <div
            ...
            >
              <div class="grid gap-4 grid-cols-2">
                <PrimaryButton
                  :target="buttons.start.href"
                  :content="buttons.start.name"
                  size="l"
                />
                <SecondaryButton
                  :target="buttons.demo.href"
                  :content="buttons.demo.name"
                  size="l"
                />
              </div>
            </div>
      ...
      <div class="relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <img
            ...
            src="@/assets/images/groupmanagement.png"
            alt="App screenshot"
          />
        </div>
      </div>
    ...
    <div class="bg-dpbm-blue">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <h2
          class="text-center text-white text-sm font-semibold uppercase tracking-wide"
        >
